...
s2[15] = map[string]string{"name":"invite", "mysql":"char(128) NOT NULL DEFAULT ''", "sqlite":"char(128) NOT NULL DEFAULT ''","postgresql":"char(128) NOT NULL DEFAULT ''", "comment": ""}
...
s2[21] = map[string]string{"name":"lang", "mysql":"char(2) NOT NULL DEFAULT ''", "sqlite":"char(2) NOT NULL DEFAULT ''","postgresql":"char(2) NOT NULL DEFAULT ''", "comment": "Запоминаем язык для юзера"}
...
s1["comment"] = "Демоны"
s["github.com/c-darwin/dcoin-go-tmp/packages/daemons"] = s1
schema.s = s
schema.printSchema()
...
s2[7] = map[string]string{"name":"tdc_amount", "mysql":"decimal(13,2)  NOT NULL DEFAULT '0'", "sqlite":"decimal(13,2)  NOT NULL DEFAULT '0'","postgresql":"decimal(13,2)  NOT NULL DEFAULT '0'", "comment": ""}
...
s2[15] = map[string]string{"name":"cash_request_in_block_id", "mysql":"int(11) NOT NULL DEFAULT '0'", "sqlite":"int(11) NOT NULL DEFAULT '0'","postgresql":"int NOT NULL DEFAULT '0'", "comment": "Нужно для отката cash_request_in"}
...
s2[16] = map[string]string{"name":"latitude", "mysql":"decimal(8,5) NOT NULL DEFAULT '0'", "sqlite":"decimal(8,5) NOT NULL DEFAULT '0'","postgresql":"decimal(8,5) NOT NULL DEFAULT '0'", "comment": ""}
s2[17] = map[string]string{"name":"longitude", "mysql":"decimal(8,5) NOT NULL DEFAULT '0'", "sqlite":"decimal(8,5) NOT NULL DEFAULT '0'","postgresql":"decimal(8,5) NOT NULL DEFAULT '0'", "comment": ""}
...
s2[1] = map[string]string{"name":"local_gate_ip", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "Если тут не пусто, то connector.php будет не активным, а ip для disseminator.php будет браться тут. Нужно для защищенного режима"}
