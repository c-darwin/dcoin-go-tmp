...
s2[44] = map[string]string{"name":"first_select", "mysql":"tinyint(1) NOT NULL DEFAULT '1'", "sqlite":"tinyint(1) NOT NULL DEFAULT '1'","postgresql":"smallint NOT NULL DEFAULT '1'", "comment": "Выбор юзера при первом заходе в кошель. Аноним или майнер"}
s2[45] = map[string]string{"name":"uniq", "mysql":"tinyint(1) NOT NULL DEFAULT '1'", "sqlite":"tinyint(1) NOT NULL DEFAULT '1'","postgresql":"smallint NOT NULL DEFAULT '1'", "comment": ""}
s1["fields"] = s2
s1["UNIQ"] = []string{"uniq"}
s1["comment"] = ""
