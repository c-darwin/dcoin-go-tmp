...
s2[41] = map[string]string{"name":"shop_secret_key", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "Секреный ключ, который используется в cron/shop.php в хэше для проверки данных на callback-е "}
s2[42] = map[string]string{"name":"shop_callback_url", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "Куда скрипт cron/shop.php будет отстукивать"}
s2[43] = map[string]string{"name":"uniq", "mysql":"tinyint(1) NOT NULL DEFAULT '1'", "sqlite":"tinyint(1) NOT NULL DEFAULT '1'","postgresql":"smallint NOT NULL DEFAULT '1'", "comment": ""}
s1["fields"] = s2
s1["UNIQ"] = []string{"uniq"}
s1["comment"] = ""
