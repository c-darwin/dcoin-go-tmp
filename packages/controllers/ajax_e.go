...
func AjaxE(w http.ResponseWriter, r *http.Request) {
	...
	if ok, _ := regexp.MatchString(`^(?i)EDelOrder|EWithdraw|EGetBalance|ESaveOrder|ESignUp|ELogin|ELogout|ESignLogin|ECheckSign|ERedirect|EInfo|EData|EGatePm|EGateIk$`, controllerName); !ok {
