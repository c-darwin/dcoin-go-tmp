...
func (schema *SchemaStruct) GetSchema() {
	...
	s2[10] = map[string]string{"name":"host", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "Хост юзера, по которому он доступен из вне"}
	...
	s2[12] = map[string]string{"name":"geolocation", "mysql":"varchar(200) NOT NULL DEFAULT ''", "sqlite":"varchar(200) NOT NULL DEFAULT ''","postgresql":"varchar(200) NOT NULL DEFAULT ''", "comment": "Текущее местонахождение майнера"}
	...
	s2[14] = map[string]string{"name":"location_country", "mysql":"tinyint(3) unsigned NOT NULL DEFAULT '0'", "sqlite":"tinyint(3)  NOT NULL DEFAULT '0'","postgresql":"smallint  NOT NULL DEFAULT '0'", "comment": ""}
	...
	s2[16] = map[string]string{"name":"face_coords", "mysql":"varchar(1024) NOT NULL DEFAULT ''", "sqlite":"varchar(1024) NOT NULL DEFAULT ''","postgresql":"varchar(1024) NOT NULL DEFAULT ''", "comment": "Точки, которе юзер нанес на свое фото"}
	s2[17] = map[string]string{"name":"node_voting_send_request", "mysql":"int(10) unsigned NOT NULL DEFAULT '0'", "sqlite":"int(10)  NOT NULL DEFAULT '0'","postgresql":"int  NOT NULL DEFAULT '0'", "comment": "Когда мы отправили запрос в DC-сеть на присвоение нам статуса \"майнер\""}
	s2[18] = map[string]string{"name":"profile_coords", "mysql":"varchar(1024) NOT NULL DEFAULT ''", "sqlite":"varchar(1024) NOT NULL DEFAULT ''","postgresql":"varchar(1024) NOT NULL DEFAULT ''", "comment": "Точки, которе юзер нанес на свое фото"}
	s2[19] = map[string]string{"name":"video_url_id", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "Видео, где показывается лицо юзера"}
	s2[20] = map[string]string{"name":"video_type", "mysql":"varchar(100) NOT NULL DEFAULT ''", "sqlite":"varchar(100) NOT NULL DEFAULT ''","postgresql":"varchar(100) NOT NULL DEFAULT ''", "comment": ""}
	...
	s2[22] = map[string]string{"name":"use_smtp", "mysql":"tinyint(1) NOT NULL DEFAULT '0'", "sqlite":"tinyint(1) NOT NULL DEFAULT '0'","postgresql":"smallint NOT NULL DEFAULT '0'", "comment": ""}
	s2[23] = map[string]string{"name":"smtp_server", "mysql":"varchar(100) NOT NULL DEFAULT ''", "sqlite":"varchar(100) NOT NULL DEFAULT ''","postgresql":"varchar(100) NOT NULL DEFAULT ''", "comment": ""}
	s2[24] = map[string]string{"name":"smtp_port", "mysql":"int(11) NOT NULL DEFAULT '0'", "sqlite":"int(11) NOT NULL DEFAULT '0'","postgresql":"int NOT NULL DEFAULT '0'", "comment": ""}
	s2[25] = map[string]string{"name":"smtp_ssl", "mysql":"tinyint(1) NOT NULL DEFAULT '0'", "sqlite":"tinyint(1) NOT NULL DEFAULT '0'","postgresql":"smallint NOT NULL DEFAULT '0'", "comment": ""}
	s2[26] = map[string]string{"name":"smtp_auth", "mysql":"tinyint(1) NOT NULL DEFAULT '0'", "sqlite":"tinyint(1) NOT NULL DEFAULT '0'","postgresql":"smallint NOT NULL DEFAULT '0'", "comment": ""}
	s2[27] = map[string]string{"name":"smtp_username", "mysql":"varchar(100) NOT NULL DEFAULT ''", "sqlite":"varchar(100) NOT NULL DEFAULT ''","postgresql":"varchar(100) NOT NULL DEFAULT ''", "comment": ""}
	s2[28] = map[string]string{"name":"smtp_password", "mysql":"varchar(100) NOT NULL DEFAULT ''", "sqlite":"varchar(100) NOT NULL DEFAULT ''","postgresql":"varchar(100) NOT NULL DEFAULT ''", "comment": ""}
	s2[29] = map[string]string{"name":"miner_pct_id", "mysql":"smallint(5) NOT NULL DEFAULT '0'", "sqlite":"smallint(5) NOT NULL DEFAULT '0'","postgresql":"smallint NOT NULL DEFAULT '0'", "comment": ""}
	s2[30] = map[string]string{"name":"user_pct_id", "mysql":"smallint(5) NOT NULL DEFAULT '0'", "sqlite":"smallint(5) NOT NULL DEFAULT '0'","postgresql":"smallint NOT NULL DEFAULT '0'", "comment": ""}
	s2[31] = map[string]string{"name":"repaid_pct_id", "mysql":"smallint(5) NOT NULL DEFAULT '0'", "sqlite":"smallint(5) NOT NULL DEFAULT '0'","postgresql":"smallint NOT NULL DEFAULT '0'", "comment": ""}
	s2[32] = map[string]string{"name":"api_token_hash", "mysql":"varchar(64) NOT NULL DEFAULT ''", "sqlite":"varchar(64) NOT NULL DEFAULT ''","postgresql":"varchar(64) NOT NULL DEFAULT ''", "comment": ""}
	s2[33] = map[string]string{"name":"sms_http_get_request", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": ""}
	s2[34] = map[string]string{"name":"notification_sms_http_get_request", "mysql":"int(11) NOT NULL DEFAULT '0'", "sqlite":"int(11) NOT NULL DEFAULT '0'","postgresql":"int NOT NULL DEFAULT '0'", "comment": ""}
	s2[35] = map[string]string{"name":"show_sign_data", "mysql":"tinyint(1) NOT NULL DEFAULT '0'", "sqlite":"tinyint(1) NOT NULL DEFAULT '0'","postgresql":"smallint NOT NULL DEFAULT '0'", "comment": "Если 0, тогда не показываем данные для подписи, если у юзера только один праймари ключ"}
	...
	s2[38] = map[string]string{"name":"hide_first_promised_amount", "mysql":"tinyint(1) NOT NULL DEFAULT '0'", "sqlite":"tinyint(1) NOT NULL DEFAULT '0'","postgresql":"smallint NOT NULL DEFAULT '0'", "comment": ""}
	s2[39] = map[string]string{"name":"hide_first_commission", "mysql":"tinyint(1) NOT NULL DEFAULT '0'", "sqlite":"tinyint(1) NOT NULL DEFAULT '0'","postgresql":"smallint NOT NULL DEFAULT '0'", "comment": ""}
	s2[40] = map[string]string{"name":"shop_secret_key", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "Секреный ключ, который используется в cron/shop.php в хэше для проверки данных на callback-е "}
	s2[41] = map[string]string{"name":"shop_callback_url", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "Куда скрипт cron/shop.php будет отстукивать"}
	...
	s2[2] = map[string]string{"name":"delete", "mysql":"tinyint(1) NOT NULL DEFAULT '0'", "sqlite":"tinyint(1) NOT NULL DEFAULT '0'","postgresql":"smallint NOT NULL DEFAULT '0'", "comment": "1-удалено. нужно для отката"}
	...
	s2[8] = map[string]string{"name":"tdc_amount_update", "mysql":"int(11) NOT NULL DEFAULT '0'", "sqlite":"int(11) NOT NULL DEFAULT '0'","postgresql":"int NOT NULL DEFAULT '0'", "comment": ""}
	s2[9] = map[string]string{"name":"video_type", "mysql":"varchar(100) NOT NULL DEFAULT ''", "sqlite":"varchar(100) NOT NULL DEFAULT ''","postgresql":"varchar(100) NOT NULL DEFAULT ''", "comment": ""}
	s2[10] = map[string]string{"name":"video_url_id", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "Если пусто, то видео берем по ID юзера.flv. На видео майнер говорит, что хочет майнить выбранную валюту"}
	s2[11] = map[string]string{"name":"votes_start_time", "mysql":"int(11) NOT NULL DEFAULT '0'", "sqlite":"int(11) NOT NULL DEFAULT '0'","postgresql":"int NOT NULL DEFAULT '0'", "comment": "При каждой смене местоположения начинается новое голосование"}
	...
	s2[15] = map[string]string{"name":"host", "mysql":"varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": ""}
	...
	s2[18] = map[string]string{"name":"country", "mysql":"tinyint(3) unsigned NOT NULL DEFAULT '0'", "sqlite":"tinyint(3)  NOT NULL DEFAULT '0'","postgresql":"smallint  NOT NULL DEFAULT '0'", "comment": ""}
	s2[19] = map[string]string{"name":"block_id", "mysql":"int(11) NOT NULL DEFAULT '0'", "sqlite":"int(11) NOT NULL DEFAULT '0'","postgresql":"int NOT NULL DEFAULT '0'", "comment": "В каком блоке было занесено. Нужно для удаления старых данных"}
	s2[20] = map[string]string{"name":"prev_log_id", "mysql":"bigint(20) NOT NULL DEFAULT '0'", "sqlite":"bigint(20) NOT NULL DEFAULT '0'","postgresql":"bigint NOT NULL DEFAULT '0'", "comment": ""}
	s1["fields"] = s2
	s1["PRIMARY"] = []string{"log_id"}
	s1["AI"] = "log_id"
	s1["comment"] = ""
	...
	s2[15] = map[string]string{"name":"host", "mysql":"varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "адрес хоста или IP, где находится нод майнера"}
	...
	s2[17] = map[string]string{"name":"longitude", "mysql":"decimal(8,5) NOT NULL", "sqlite":"decimal(8,5) NOT NULL","postgresql":"decimal(8,5) NOT NULL", "comment": ""}
	s2[18] = map[string]string{"name":"country", "mysql":"tinyint(3) unsigned NOT NULL DEFAULT '0'", "sqlite":"tinyint(3)  NOT NULL DEFAULT '0'","postgresql":"smallint  NOT NULL DEFAULT '0'", "comment": ""}
	s2[19] = map[string]string{"name":"log_id", "mysql":"bigint(20) NOT NULL DEFAULT '0'", "sqlite":"bigint(20) NOT NULL DEFAULT '0'","postgresql":"bigint NOT NULL DEFAULT '0'", "comment": ""}
	s1["fields"] = s2
	s1["PRIMARY"] = []string{"user_id"}
	s1["comment"] = ""
	s["miners_data"] = s1
	...
	s2[5] = map[string]string{"name":"for_self_use", "mysql":"tinyint(1) NOT NULL DEFAULT '0'", "sqlite":"tinyint(1) NOT NULL DEFAULT '0'","postgresql":"smallint NOT NULL DEFAULT '0'", "comment": "для new_pct(pct_generator.php), т.к. эта тр-ия валидна только вместе с блоком, который сгенерил тот, кто сгенерил эту тр-ию"}
	...
	s1=make(recmap)
	s2=make(recmapi)
	s2[0] = map[string]string{"name":"php_path", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "Нужно для запуска демонов"}
	s2[1] = map[string]string{"name":"my_block_id", "mysql":"int(11) NOT NULL DEFAULT '0'", "sqlite":"int(11) NOT NULL DEFAULT '0'","postgresql":"int NOT NULL DEFAULT '0'", "comment": "Параллельно с info_block пишем и сюда. Нужно при обнулении рабочих таблиц, чтобы знать до какого блока не трогаем таблы my_"}
	s2[2] = map[string]string{"name":"local_gate_ip", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "Если тут не пусто, то connector.php будет не активным, а ip для disseminator.php будет браться тут. Нужно для защищенного режима"}
	s2[3] = map[string]string{"name":"static_node_user_id", "mysql":"int(11) NOT NULL DEFAULT '0'", "sqlite":"int(11) NOT NULL DEFAULT '0'","postgresql":"int NOT NULL DEFAULT '0'", "comment": "Все исходящие тр-ии будут подписаны публичным ключом этой ноды. Нужно для защищенного режима"}
	s2[4] = map[string]string{"name":"in_connections_ip_limit", "mysql":"int(11) NOT NULL DEFAULT '0'", "sqlite":"int(11) NOT NULL DEFAULT '0'","postgresql":"int NOT NULL DEFAULT '0'", "comment": "Кол-во запросов от 1 ip за минуту"}
	s2[5] = map[string]string{"name":"in_connections", "mysql":"int(11) NOT NULL DEFAULT '0'", "sqlite":"int(11) NOT NULL DEFAULT '0'","postgresql":"int NOT NULL DEFAULT '0'", "comment": "Кол-во нодов и просто юзеров, от кого принимаем данные. Считаем кол-во ip за 1 минуту"}
	s2[6] = map[string]string{"name":"out_connections", "mysql":"int(11) NOT NULL DEFAULT '0'", "sqlite":"int(11) NOT NULL DEFAULT '0'","postgresql":"int NOT NULL DEFAULT '0'", "comment": "Кол-во нодов, кому шлем данные"}
	s2[7] = map[string]string{"name":"bad_blocks", "mysql":"text NOT NULL DEFAULT ''", "sqlite":"text NOT NULL DEFAULT ''","postgresql":"text NOT NULL DEFAULT ''", "comment": "Номера и sign плохих блоков. Нужно, чтобы не подцепить более длинную, но глючную цепочку блоков"}
	...
	s2[9] = map[string]string{"name":"pool_admin_user_id", "mysql":"int(11) NOT NULL DEFAULT '0'", "sqlite":"int(11) NOT NULL DEFAULT '0'","postgresql":"int NOT NULL DEFAULT '0'", "comment": ""}
	s2[10] = map[string]string{"name":"pool_tech_works", "mysql":"tinyint(1) NOT NULL DEFAULT '0'", "sqlite":"tinyint(1) NOT NULL DEFAULT '0'","postgresql":"smallint NOT NULL DEFAULT '0'", "comment": ""}
	s2[11] = map[string]string{"name":"exchange_api_url", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "На home далается ajax-запрос к api биржи и выдается инфа о курсе и пр."}
	s2[12] = map[string]string{"name":"cf_url", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "URL, который отображается в соц. кнопках и с которого подгружаются css/js/img/fonts при прямом заходе в CF-каталог"}
	s2[13] = map[string]string{"name":"pool_url", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "URL, на который ссылается кнопка Contribute now из внешнего CF-каталога "}
	s2[14] = map[string]string{"name":"pool_email", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "В режиме пула используется как адрес отправителя при рассылке уведомлений"}
	s2[15] = map[string]string{"name":"cf_available_coins_url", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "URL биржи, где можно узнать, сколько там осталось монет в продаже по курсу 1"}
	s2[16] = map[string]string{"name":"cf_exchange_url", "mysql":"varchar(255) NOT NULL DEFAULT ''", "sqlite":"varchar(255) NOT NULL DEFAULT ''","postgresql":"varchar(255) NOT NULL DEFAULT ''", "comment": "URL биржи. Просто, чтобы дать на неё ссылку в сообщении, где говорится, что монеты на бирже кончились"}
	s2[17] = map[string]string{"name":"cf_top_html", "mysql":"text CHARACTER SET utf8 NOT NULL DEFAULT ''", "sqlite":"text NOT NULL DEFAULT ''","postgresql":"text NOT NULL DEFAULT ''", "comment": "html-код с платежными системами для страницы cf_page_preview"}
	s2[18] = map[string]string{"name":"cf_bottom_html", "mysql":"text CHARACTER SET utf8 NOT NULL DEFAULT ''", "sqlite":"text NOT NULL DEFAULT ''","postgresql":"text NOT NULL DEFAULT ''", "comment": "html-код с платежными системами для страницы cf_page_preview"}
